<router-link tag="h3" :to="{
    ...
    <span class="sidebar-label">{{ config('page-object-manager.labels.pages') }}</span>
</router-link>
<router-link tag="h3" :to="{
    name: 'index',
    params: {
        resourceName: 'nova-block'
    }
}" class="cursor-pointer flex items-center font-normal dim text-white mb-6 text-base no-underline">
    ...
    <span class="sidebar-label">{{ config('page-object-manager.labels.blocks') }}</span>
</router-link>
